...
@Service
@Transactional
public class ReactivateClassService implements ReactivateClassUseCase {

    private final ProgramClassRepository programClassRepository;
    private final ApplicationEventPublisher eventPublisher;

    public ReactivateClassService(ProgramClassRepository programClassRepository,
    ...
    @Override
    public ProgramClass execute(UUID tenantId, UUID classId, UUID reactivatedBy) {
        ...
        programClass.reactivate(reactivatedBy);
