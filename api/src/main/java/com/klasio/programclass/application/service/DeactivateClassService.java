...
@Service
@Transactional
public class DeactivateClassService implements DeactivateClassUseCase {

    private final ProgramClassRepository programClassRepository;
    private final ApplicationEventPublisher eventPublisher;

    public DeactivateClassService(ProgramClassRepository programClassRepository,
    ...
    @Override
    public ProgramClass execute(UUID tenantId, UUID classId, UUID deactivatedBy) {
        ...
        programClass.deactivate(deactivatedBy);
