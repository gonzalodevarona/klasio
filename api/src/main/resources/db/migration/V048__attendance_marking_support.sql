-- V048: attendance marking support (RF-25, RF-26)
-- 1. Add PRESENT_NO_HOURS to attendance_registrations.status CHECK
-- 2. Add correction columns to attendance_registrations
-- 3. Extend audit_log.action_type CHECK with 4 new marking action types
...
-- ============================================================
-- 2. Add correction tracking columns (nullable)
-- ============================================================
ALTER TABLE attendance_registrations
...
--    Full list from V047 + 4 new attendance marking types
-- ============================================================
