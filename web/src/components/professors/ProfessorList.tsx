...
export default function ProfessorList() {
  ...
  const [statusFilter, setStatusFilter] = useState<ProfessorStatus | undefined>(
    undefined
  );
  const SIZE = 20;

  const { professors, totalPages, totalElements, loading, error } = useProfessors(
    page,
    SIZE,
    statusFilter
  );
  ...
  function handleStatusChange(value: string) {
    setStatusFilter(value === "" ? undefined : (value as ProfessorStatus));
    setPage(0);
  }
